...
(689, 'aleyna', '5949583', 'fdskglks'),
(66565, 'kgskdjgs', '656564', 'fksflsdk');
...
--
-- Table structure for table `restaurant_management`
--

CREATE TABLE `restaurant_management` (
  `mgmt_id` int(11) NOT NULL,
  `restaurant_name` varchar(150) DEFAULT NULL,
  `location` varchar(150) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- Dumping data for table `restaurant_management`
--

INSERT INTO `restaurant_management` (`mgmt_id`, `restaurant_name`, `location`) VALUES
(54654, 'skfjkfksj', 'ksfkjsf'),
(545656, 'aleynasbruger', 'magusa'),
(564654, 'kdsgjkd', 'dgksgs');
...
--
-- Indexes for table `restaurant_management`
--
